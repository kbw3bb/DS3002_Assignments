...
#I decided to use a local csv file on my computer, thats being read in from a link on github
...
#2 / #4
# Convert the general format and data structure of the data source (from CSV to JSON)
# 2 WAYS:
#1st way:
...
make_json(csv_file_path, json_file_path) #Now call the function
